...
class Game:
    ...
    def loadData(self):    
        ...
        self.healthupImages = {}
        self.healthupImages['normalheal'] = pg.image.load(path.join(img_folder, HEALTHUP_POWER)).convert_alpha()
        self.healthupImages['superheal'] = pg.image.load(path.join(img_folder, SUPERHEALTHUP_POWER)).convert_alpha()
        #load score file
